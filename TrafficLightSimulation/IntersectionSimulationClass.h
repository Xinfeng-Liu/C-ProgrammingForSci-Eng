...
class IntersectionSimulationClass
{
  private:
    ...
    //directional current time
    int northCurrentTime;
    int southCurrentTime;
    int eastCurrentTime;
    int westCurrentTime;
  ...
  public:
    ...
    //compute dirctional current time, and determin arrival direction
    void scheduleArrivalHelper(int &dictionCurrentTime, 
                               int dirctMean, int dirctStd, 
                               int &directionTime, 
                               int &currentTypeId, 
    ...
    void handleNextArrival(const std::string dirction, 
                           int dirctCurrentTime, 
                           FIFOQueueClass< CarClass >& dirctQueue, 
                           int& maxDirctQueueLength);
    
    //Handel next event that will change to green light
    int handleNextGreenLight(FIFOQueueClass< CarClass >& dirctQueue, 
                             int dirctColorLightTime, 
                             std::string direction, 
                             int& numTotalAdvancedDirct);
    
    //Handel next event that will change to yellow light
    int handleNextYellowLight(FIFOQueueClass< CarClass >& dirctQueue, 
                              int dirctColorLightTime, 
                              std::string direction, 
                              int& numTotalAdvancedDirct);
